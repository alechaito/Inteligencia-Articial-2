...
void mostrar_sinapses()
{
  int i, j;
    ...
    for (i = 0; i < ENTRADAS+1; i++) {
        ...
        printf("w_e_o_1[%d][%d]: %f ", i, j, w_e_o_1[i][j]);
        }
        printf("\n");
    }
    ...
    for (i = 0; i < NR_NEURON_O+1; i++) {
        for (j =0; j < NR_NEURON_O; j++) {
            printf("w_o_s_1[%d][%d]: %f ", i, j, w_o_s_1[i][j]);
        }
        printf("\n");
    }
  ...
  for (i = 0; i < NR_NEURON_O+1; i++) {
    for (j =0; j < SAIDAS; j++) {
      printf("w_o_s_2[%d][%d]: %f ", i, j, w_o_s_2[i][j]);
    }
    printf("\n");
  }
}
...
void treinar_RNA(int motor)
{
  ...
  for (i = 1; i <= EPOCAS; i++) {
    ...
    for (j = 0; j < NR_AMOSTRAS; j++) {
        ...
        calcular_delta_saida(cj_treinamento[j][motor]);
...
void menu()
{
  ...
  switch (opcao) {
    ...
    case 2: printf("Insira uma entrada: ");
            scanf("%lf", &entradas[0]);
            calcular_saidas(entradas);
            printf("------------------------------------------------------\n");
            printf("Saida para o motor escolhido => %lf \n", motor, saida_s[0]);
            printf("------------------------------------------------------\n");
